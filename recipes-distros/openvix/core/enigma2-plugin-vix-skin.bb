...
RDEPENDS_${EPSM}-magic-sd = "font-valis-enigma"
RDEPENDS_${EPSM}-magic-hd = "font-valis-enigma"
RDEPENDS_${EPSM}-magic-hd-light = "font-valis-enigma ${EPSM}-magic-hd"

RDEPENDS_${EPSM}-magic-hd-noire = "font-valis-enigma vix-mhdc"
RDEPENDS_${EPSM}-magic-hd-night = "font-valis-enigma vix-mhdc"
