...
PACKAGES = "vix-skin-common ${EPSM}-day-hd ${EPSM}-night-hd vix-magic-hd-common ${EPSM}-magic-sd ${EPSM}-magic-hd-full vix-mhdc ${EPSM}-magic-hd-noire ${EPSM}-magic-hd-night vix-vixbmc-hd-common ${EPSM}-vixbmc-slim-hd ${EPSM}-vixbmc-night-hd ${EPSM}-vixbmc-metropolis"
PROVIDES = "${PN} vix-skin-common ${EPSM}-mhdc ${EPSM}-night-hd vix-magic-hd-common ${EPSM}-magic-sd ${EPSM}-magic-hd-full vix-mhdc ${EPSM}-magic-hd-noire ${EPSM}-magic-hd-night vix-vixbmc-hd-common ${EPSM}-vixbmc-slim-hd ${EPSM}-vixbmc-night-hd ${EPSM}-vixbmc-metropolis"
...
RCONFLICTS_${EPSM}-magic-hd-full = "enigma2-plugin-vix-magic-hd"
RREPLACES_${EPSM}-magic-hd-full = "enigma2-plugin-vix-magic-hd"
...
FILES_${EPSM}-magic-hd-full = "/usr/share/enigma2/Magic-HD/"
...
RDEPENDS_${EPSM}-magic-hd-full = "${RDEPHD}"
RDEPENDS_${EPSM}-magic-hd-noire = "font-valis-hd vix-mhd"
RDEPENDS_${EPSM}-magic-hd-night = "${RDEPHD} vix-mhdc"
