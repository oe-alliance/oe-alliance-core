...
PROVIDES = "${PN} vix-skin-common ${EPSM}-day-hd ${EPSM}-night-hd vix-magic-hd-common ${EPSM}-magic-sd ${EPSM}-magic-hd-full vix-mhdc ${EPSM}-magic-hd-noire ${EPSM}-magic-hd-night vix-vixbmc-hd-common ${EPSM}-vixbmc-slim-hd ${EPSM}-vixbmc-night-hd ${EPSM}-vixbmc-metropolis"
