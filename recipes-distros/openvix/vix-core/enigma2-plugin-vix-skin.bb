...
PACKAGES = "vix-skin-common ${EPSM}-day-hd ${EPSM}-night-hd vix-magic-hd-common ${EPSM}-magic-hd ${EPSM}-magic-hd-lite ${EPSM}-magic-hd-night vix-vixbmc-hd-common ${EPSM}-vixbmc-slim-hd ${EPSM}-vixbmc-night-hd ${EPSM}-vixbmc-metropolis"
PROVIDES = "${PN} vix-skin-common ${EPSM}-day-hd ${EPSM}-night-hd vix-magic-hd-common ${EPSM}-magic-hd ${EPSM}-magic-hd-lite ${EPSM}-magic-hd-night vix-vixbmc-hd-common ${EPSM}-vixbmc-slim-hd ${EPSM}-vixbmc-night-hd ${EPSM}-vixbmc-metropolis"
...
RCONFLICTS_${EPSM}-magic-hd-lite = "enigma2-plugin-vix-magic-hd-lite"
RREPLACES_${EPSM}-magic-hd-lite = "enigma2-plugin-vix-magic-hd-lite"
...
FILES_${EPSM}-magic-hd-lite = "/usr/share/enigma2/Magic-HD-Light/"
...
RDEPENDS_${EPSM}-magic-hd-lite = "${RDEPHD}"
RDEPENDS_${EPSM}-magic-hd-night = "${RDEPHD}"
