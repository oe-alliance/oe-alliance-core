...
PACKAGES = "vix-skin-common ${EPSM}-day-hd vix-mhdc ${EPSM}-night-hd vix-magic-hd-common ${EPSM}-magic-sd ${EPSM}-magic-hd ${EPSM}-magic-hd-night vix-vixbmc-hd-common ${EPSM}-vixbmc-slim-hd ${EPSM}-vixbmc-night-hd ${EPSM}-vixbmc-metropolis"
PROVIDES = "${PN} vix-skin-common vix-mhdc ${EPSM}-mhdc ${EPSM}-night-hd vix-magic-hd-common ${EPSM}-magic-sd ${EPSM}-magic-hd ${EPSM}-magic-hd-night vix-vixbmc-hd-common ${EPSM}-vixbmc-slim-hd ${EPSM}-vixbmc-night-hd ${EPSM}-vixbmc-metropolis"
