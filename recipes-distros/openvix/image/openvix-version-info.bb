...
URL_maram9 = "http://www.mara-support.co.uk"
...
do_install() {
			...
			elif [ "${MACHINE}" = "maram9" ]; then
				DRIVERS=`grep "SRCDATE = " ${OE-ALLIANCE_BASE}/meta-oe-alliance/recipes-bsp/mara/mara-dvb-modules-${MACHINE}.bb | cut -b 12-19`
