...
do_install() {
            ...
            elif [ "${MACHINE}" = "ventonhdx" -o "${MACHINE}" = "inihde" ]; then
            ...
            echo "comment=MK-Digital" >> ${D}/etc/image-version
            echo "target=9" >> ${D}/etc/image-version
            echo "creator=MK-Digital" >> ${D}/etc/image-version
