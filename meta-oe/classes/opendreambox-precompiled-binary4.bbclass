...
PRECOMPILED_URI ?= "http://dreamboxupdate.com/download/opendreambox/2.6.0/${@precompiledPath(d)};name=${PRECOMPILED_ARCH}"
...
MIRRORS =+ " \
http://dreamboxupdate.com/download/opendreambox/2.6.0/	http://dreamboxupdate.com/download/opendreambox/2.5.0/ \n \
"
