...
DEPENDS = "bzip2 gstreamer1.0 gstreamer1.0-plugins-base xz zlib"
...
SRC_URI = "git://gitlab.freedesktop.org/gstreamer/gst-libav;protocol=https;branch=master;name=gst_libav \
            ...
            file://0007-dont-hardcode-libdir.patch \
"
...
EXTRA_OEMESON = "-Ddoc=disabled --buildtype=release --libdir=${libdir}/gstreamer-1.0"
...
FILES_${PN} += "${libdir}/gstreamer-1.0/*.so.* ${libdir}/gstreamer-1.0/libgst*.so"
FILES_${PN}-dev += "${libdir}/gstreamer-1.0/*.la ${libdir}/gstreamer-1.0/pkgconfig/* ${libdir}/gstreamer-1.0/libav*.so \
                    ${libdir}/gstreamer-1.0/libsw*.so ${libdir}/gstreamer-1.0/libpostproc.so"
