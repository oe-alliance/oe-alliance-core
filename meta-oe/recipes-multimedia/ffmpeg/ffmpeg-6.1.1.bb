...
SRC_URI = " \
    https://www.ffmpeg.org/releases/ffmpeg-6.1.1.tar.xz \
...
FILES:${PN} += "${datadir}"
FILES:libavcodec-${PV} = "${libdir}/libavcodec${SOLIBS}"
FILES:libavdevice-${PV} = "${libdir}/libavdevice${SOLIBS}"
FILES:libavfilter-${PV} = "${libdir}/libavfilter${SOLIBS}"
FILES:libavformat-${PV} = "${libdir}/libavformat${SOLIBS}"
FILES:libavutil-${PV} = "${libdir}/libavutil${SOLIBS}"
FILES:libpostproc-${PV} = "${libdir}/libpostproc${SOLIBS}"
FILES:libswresample-${PV} = "${libdir}/libswresample${SOLIBS}"
FILES:libswscale-${PV} = "${libdir}/libswscale${SOLIBS}"
