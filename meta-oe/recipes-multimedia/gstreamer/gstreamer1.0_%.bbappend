...
# OpenATV only, see 0001-input-selector-release-active-sinkpad-lock-across-p.patch
SRC_URI:append:openatv = " file://0001-input-selector-release-active-sinkpad-lock-across-p.patch"
