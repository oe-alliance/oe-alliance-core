...
do_install() {
    ...
    install -m 0655 ${S}/config.txt ${D}${nonarch_base_libdir}/firmware/ap6212
    ...
    if ${@bb.utils.contains('DISTRO_FEATURES', 'sysvinit', 'true', 'false', d)}; then
        ...
        install -m 0755 ${S}/ap6212-bluetooth ${D}${sysconfdir}/init.d/ap6212

        install -d "${D}${sysconfdir}/default"
        install -m 0644 ${S}/ap6212-default ${D}${sysconfdir}/default/ap6212
    fi
}
