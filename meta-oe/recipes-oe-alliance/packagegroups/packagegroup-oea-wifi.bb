SUMMARY = "OE-Alliance WiFi - preinstall WiFi driver packages"
LICENSE = "MIT"
...
RDEPENDS:${PN} = "\
    ...
    ${@bb.utils.contains("MACHINE_BRAND", "Vu+", "enigma2-plugin-drivers-network-usb-rtl8192cu enigma2-plugin-drivers-network-usb-rtl8192eu", "", d)} \
    ...
    ${@bb.utils.contains("DISTRO_NAME", "beyonwiz", "enigma2-plugin-drivers-network-usb-rtl8192cu enigma2-plugin-drivers-network-usb-rtl8812au", "", d)} \
    ${@bb.utils.contains("DISTRO_NAME", "openvix", "enigma2-plugin-drivers-network-usb-rtl8192cu enigma2-plugin-drivers-network-usb-rtl8812au", "", d)} \
    ...
    ${@bb.utils.contains("DISTRO_NAME", "egami", "enigma2-plugin-drivers-network-usb-rtl8192cu enigma2-plugin-drivers-network-usb-rtl8812au", "", d)} \
    ${@bb.utils.contains("DISTRO_NAME", "opendroid", "enigma2-plugin-drivers-network-usb-rtl8192cu", "", d)} \
    ${@bb.utils.contains("DISTRO_NAME", "openhdf", "enigma2-plugin-drivers-network-usb-rtl8192cu enigma2-plugin-drivers-network-usb-rtl8812au", "", d)} \
    ${@bb.utils.contains("DISTRO_NAME", "openbh", "enigma2-plugin-drivers-network-usb-rtl8192cu enigma2-plugin-drivers-network-usb-rtl8812au", "", d)} \
    ...
    ${@bb.utils.contains("MACHINE", "sx988", "enigma2-plugin-drivers-network-usb-rtl8821cu enigma2-plugin-drivers-network-usb-rtl8192eu enigma2-plugin-drivers-network-usb-mt7601u enigma2-plugin-drivers-network-usb-rtl8822cu enigma2-plugin-drivers-network-usb-rtl8188fu", "", d)} \
    ${@bb.utils.contains("MACHINE", "sfx6008", "enigma2-plugin-drivers-network-usb-rtl8821cu enigma2-plugin-drivers-network-usb-rtl8192eu enigma2-plugin-drivers-network-usb-mt7601u enigma2-plugin-drivers-network-usb-rtl8822cu enigma2-plugin-drivers-network-usb-rtl8188fu", "", d)} \
    ...
    ${@bb.utils.contains("MACHINE", "h17", "enigma2-plugin-drivers-network-usb-rtl8192eu enigma2-plugin-drivers-network-usb-mt7601u enigma2-plugin-drivers-network-usb-rtl8822bu enigma2-plugin-drivers-network-usb-rtl8192fu", "", d)} \
