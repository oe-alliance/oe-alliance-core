...
SRC_URI = "git://github.com/oe-alliance/oe-alliance-e2-skindefault.git;protocol=https;branch=7.6"
SRC_URI:openatv = "git://github.com/openatv/oe-alliance-e2-skindefault.git;protocol=https;branch=7.6"
