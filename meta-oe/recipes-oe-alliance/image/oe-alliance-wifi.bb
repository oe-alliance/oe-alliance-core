...
RDEPENDS_${PN} = "\
    ...
    ${@bb.utils.contains("MACHINE", "h10", "enigma2-plugin-drivers-network-usb-rtl8192eu kernel-module-mt7601u firmware-mt7601u enigma2-plugin-drivers-network-usb-rtl8822bu enigma2-plugin-drivers-network-usb-rt8723bu", "", d)} \
