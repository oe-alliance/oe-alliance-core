...
RDEPENDS_${PN} = "\
    ...
    ${@bb.utils.contains("MACHINE", "osninopro", "enigma2-plugin-drivers-network-usb-rt8723bs", "", d)} \
    ...
    ${@bb.utils.contains("MACHINE", "h9", "enigma2-plugin-drivers-network-usb-rtl8192eu enigma2-plugin-drivers-network-usb-mt7601u", "", d)} \
    ${@bb.utils.contains("MACHINE", "h9combo", "enigma2-plugin-drivers-network-usb-rtl8192eu enigma2-plugin-drivers-network-usb-mt7601u", "", d)} \
    ${@bb.utils.contains("MACHINE", "i55plus", "enigma2-plugin-drivers-network-usb-rtl8192eu enigma2-plugin-drivers-network-usb-mt7601u", "", d)} \
