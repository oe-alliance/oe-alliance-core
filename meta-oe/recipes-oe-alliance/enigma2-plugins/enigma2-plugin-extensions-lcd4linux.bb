...
RDEPENDS:${PN} = "enigma2-plugin-extensions-lcd4linux-src dpflib python3-icalendar python3-pyusb python3-codecs python3-datetime python3-pillow python3-image python3-shell python3-ctypes libusb-0.1-4 python3-mutagen python3-email python3-simplejson python3-soco"
DEPENDS = "png-util"
