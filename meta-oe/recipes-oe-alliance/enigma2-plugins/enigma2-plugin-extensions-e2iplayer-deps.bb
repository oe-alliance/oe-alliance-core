...
S1 = "${UNPACKDIR}/${PN}-${PV}/e2isubparser"
...
S3 = "${UNPACKDIR}/${PN}-${PV}/lsdir"
SOURCE_FILES3 = "src/lsdir.c"

S4 = "${UNPACKDIR}/${PN}-${PV}/cmdwrap"
SOURCE_FILES4 = "src/cmdwrap.c"

S5 = "${UNPACKDIR}/${PN}-${PV}/f4mdump"
