...
THIRDPARTY_PLUGINS = " \
    ...
    enigma2-plugin-extensions-jedimakerxtream_4.21-20190708_all.ipk \
    ...
    enigma2-plugin-extensions-webradiofs_18.10_all.ipk \
    ...
    enigma2-plugin-skins-OverlayHD_1.72_all.ipk \
