...
THIRDPARTY_PLUGINS = " \
    ...
    enigma2-plugin-extensions-e2m3u2bouquet_0.7.6_all.ipk \
    ...
    enigma2-plugin-extensions-ipchecker_002_all.ipk \
    ${@bb.utils.contains("TARGET_ARCH", "sh4", "enigma2-plugin-extensions-isettinge2-3.4.2-oe2.0-all-sh4.ipk" , "", d)} \
    ${@bb.utils.contains("TARGET_ARCH", "mipsel", "enigma2-plugin-extensions-isettinge2_3.4.2-oe2.0-all-mips_all.ipk" , "", d)} \
    ${@bb.utils.contains("TARGET_ARCH", "arm", "enigma2-plugin-extensions-isettinge2-3.4.2-oe2.0-all-arm.ipk" , "", d)} \
    ...
    enigma2-plugin-extensions-planerfs_9.31_all.ipk \
    ...
    enigma2-plugin-extensions-serienrecorder_3.7.0_all.ipk \
    ...
    enigma2-plugin-extensions-tvspielfilm_6.6rc3_all.ipk \
    enigma2-plugin-extensions-verkehrsinfo_1.2rc2_all.ipk \
    ...
    enigma2-plugin-extensions-webradiofs_17.22_all.ipk \
    ...
    enigma2-plugin-extensions-zdfnewmediathek_2.1rc14_all.ipk \
