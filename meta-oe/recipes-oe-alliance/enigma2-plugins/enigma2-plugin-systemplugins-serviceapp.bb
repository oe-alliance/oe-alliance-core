...
SRC_URI:openspa = "git://github.com/oe-mirrors/serviceapp.git;branch=sig3;protocol=https"
...
CXXFLAGS += "${@bb.utils.contains_any("DISTRO_NAME", "openatv openvix openbh openspa teamblue", "" , " -std=c++11", d)}"
