...
DEPENDS = "python"
RDEPENDS_${PN} = "${@bb.utils.contains("GST_VERSION", "1.0", "gstreamer1.0-plugins-bad-fragmented", "gst-plugins-bad-fragmented", d)} curl mjpegtools python-ctypes libshowiframe0"
