...
EXTRA_OECMAKE += "-DRAPIDJSON_BUILD_DOC=OFF -DRAPIDJSON_BUILD_TESTS=OFF -DRAPIDJSON_BUILD_EXAMPLES=OFF -DBASE_LIB_PATH=${baselib} -DCMAKE_POLICY_VERSION_MINIMUM=3.5"
