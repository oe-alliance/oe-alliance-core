...
cp $config_dir/start $config_dir/.start-init
cp $config_dir/reload $config_dir/.reload-init
cp $config_dir/restart $config_dir/.restart-by-force-kill-init
cp $config_dir/stop $config_dir/.restart-by-force-kill-init
chmod 755 $config_dir/.start-init $config_dir/.restart-by-force-kill-init $config_dir/.restart-by-force-kill-init $config_dir/.reload-init
echo "..done"
echo ""
