...
FILES_enigma2-plugin-skins-metrix-beyonwiz-fhd-icons = "${datadir}/enigma2/MetrixHD/FHD"
FILES_enigma2-plugin-skins-metrix-beyonwiz-uhd-icons = "${datadir}/enigma2/MetrixHD/UHD"
FILES_${PN}-src = "\
