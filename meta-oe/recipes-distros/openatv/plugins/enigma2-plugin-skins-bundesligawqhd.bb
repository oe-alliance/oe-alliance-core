SUMMARY = "BundesligaWQHD skin for openATV images"
DESCRIPTION = "WQHD Bundesliga skin and configuration plugin for openATV images."
...
S = "${UNPACKDIR}/${BP}/BundesligaWQHD"

RDEPENDS:${PN} += "enigma2-plugin-extensions-oaweather"

SKIN_DIR = "${datadir}/enigma2/BundesligaWQHD"
PLUGIN_DIR = "${libdir}/enigma2/python/Plugins/Extensions/BundesligaWQHD"
TRANSLATION_DOMAIN = "BundesligaWQHD"

FILES:${PN} = " \
    ${SKIN_DIR} \
    ${PLUGIN_DIR} \
    ${libdir}/enigma2/python/Components/Converter/BLWQHD*.pyc \
    ${libdir}/enigma2/python/Components/Renderer/BLWQHD*.pyc \
"

FILES:${PN}-src = " \
    ${PLUGIN_DIR}/*.py \
    ${libdir}/enigma2/python/Components/Converter/BLWQHD*.py \
    ${libdir}/enigma2/python/Components/Renderer/BLWQHD*.py \
"
