...
SRC_URI = "file://bootlogo.mvi file://backdrop.mvi file://radio.mvi file://bootlogo.sh ${@bb.utils.contains("MACHINE_FEATURES", "bootsplash", "file://splash.bin " , "", d)} \
    ...
    ${@bb.utils.contains("MACHINE_FEATURES", "H9SDcard", "file://bootargs-nand.bin file://bootargs-mmc.bin file://bootargs-usb.bin" , "", d)} \
"
...
do_install() {
    ...
    ${@bb.utils.contains("MACHINE_FEATURES", "H9SDcard", "install -m 0644 bootargs-nand.bin ${D}/usr/share/bootargs-nand.bin" , "", d)}
    ${@bb.utils.contains("MACHINE_FEATURES", "H9SDcard", "install -m 0644 bootargs-mmc.bin ${D}/usr/share/bootargs-mmc.bin" , "", d)}
    ${@bb.utils.contains("MACHINE_FEATURES", "H9SDcard", "install -m 0644 bootargs-usb.bin ${D}/usr/share/bootargs-usb.bin" , "", d)}
