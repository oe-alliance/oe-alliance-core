...
RDEPENDS:${PN}-meta = ""
RDEPENDS:enigma2-plugin-skins-openvix-metrixhd = "enigma2-plugin-skincomponents-metrix"
RDEPENDS:enigma2-plugin-skins-openvix-metrixfhd = "enigma2-plugin-skincomponents-metrix"
RDEPENDS:enigma2-plugin-skins-openvix-mynovum-fhd2 = "enigma2-plugin-skincomponents-novum"
RDEPENDS:enigma2-plugin-skins-openvix-mynovum-fhd2-black = "enigma2-plugin-skincomponents-novum"
RDEPENDS:enigma2-plugin-skins-openvix-novum-fhd-slim = "enigma2-plugin-skincomponents-novum"
...
RDEPENDS:enigma2-plugin-skins-openvix-vix-day-hd = "enigma2-plugin-skins-openvix-vix-common font-roboto-enigma"
RDEPENDS:enigma2-plugin-skins-openvix-vix-night-hd = "enigma2-plugin-skins-openvix-vix-common font-roboto-enigma"
RDEPENDS:enigma2-plugin-skins-openvix-vix-day-1080 = "enigma2-plugin-skins-openvix-vix-1080-common font-roboto-enigma"
RDEPENDS:enigma2-plugin-skins-openvix-vix-night-1080 = "enigma2-plugin-skins-openvix-vix-1080-common font-roboto-enigma"
...
FILES:enigma2-plugin-skincomponents-metrix += " ${libdir}/enigma2/python/Components/Converter/RemainingToTextMod.pyo ${libdir}/enigma2/python/Components/Converter/MetrixCombinedEventName.pyo ${libdir}/enigma2/python/Components/Converter/ClockToTextMod.pyo ${libdir}/enigma2/python/Components/Converter/MetrixRefString.pyo ${libdir}/enigma2/python/Components/Converter/vhdConvEventName.pyo ${libdir}/enigma2/python/Components/Converter/MetrixWeather.pyo ${libdir}/enigma2/python/Components/Converter/EventNameMod.pyo ${libdir}/enigma2/python/Components/Renderer/VReference.py ${libdir}/enigma2/python/Components/Renderer/VReference.pyo ${libdir}/enigma2/python/Components/Renderer/XPicon.pyo ${libdir}/enigma2/python/Components/Renderer/XPiconChannel.pyo ${libdir}/enigma2/python/Components/Renderer/VVolumeText.pyo ${libdir}/enigma2/python/Components/Renderer/NextEvent.pyo"
FILES:enigma2-plugin-skincomponents-metrix-src += " ${libdir}/enigma2/python/Components/Converter/EventNameMod.py ${libdir}/enigma2/python/Components/Converter/RemainingToTextMod.py ${libdir}/enigma2/python/Components/Converter/vhdConvEventName.py ${libdir}/enigma2/python/Components/Converter/MetrixRefString.py ${libdir}/enigma2/python/Components/Converter/MetrixWeather.py ${libdir}/enigma2/python/Components/Converter/MetrixCombinedEventName.py ${libdir}/enigma2/python/Components/Converter/ClockToTextMod.py ${libdir}/enigma2/python/Components/Renderer/VVolumeText.py ${libdir}/enigma2/python/Components/Renderer/XPicon.py ${libdir}/enigma2/python/Components/Renderer/XPiconChannel.py ${libdir}/enigma2/python/Components/Renderer/NextEvent.py"
FILES:enigma2-plugin-skincomponents-novum += " ${libdir}/enigma2/python/Components/Renderer/NovSingleEpgListNobile.pyo  ${libdir}/enigma2/python/Components/Converter/NovumEventsInfo.pyo"
FILES:enigma2-plugin-skincomponents-novum-src += " ${libdir}/enigma2/python/Components/Renderer/NovSingleEpgListNobile.py  ${libdir}/enigma2/python/Components/Converter/NovumEventsInfo.py"
...
DESCRIPTION:enigma2-plugin-skins-openvix-vix-day-1080 = "1080 skin for OpenViX"
DESCRIPTION:enigma2-plugin-skins-openvix-vix-night-1080 = "1080 skin for OpenViX"
