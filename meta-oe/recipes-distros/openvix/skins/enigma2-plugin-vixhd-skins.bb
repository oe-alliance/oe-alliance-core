...
PACKAGES = "youvix-common ${EPSM}-youvix-blue ${EPSM}-youvix-red ${EPSM}-youvix-green ${EPSM}-youvix-purple ${EPSM}-vixbmc-1080 ${EPSM}-vixbmc-1080-bello"
...
FILES_${EPSM}-vixbmc-1080-bello = "/usr/share/enigma2/ViXBMC_1080_Bello"
