...
RDEPENDS:enigma2-plugin-softcams-scam = "libcrypto-compat-0.9.7 libxcrypt-compat"
...
RPROVIDES:enigma2-plugin-softcams-scam += "openvix-softcams-scam"
...
FILES:enigma2-plugin-softcams-scam = "/usr"
