...
RDEPENDS:enigma2-plugin-softcams-evocamd = "libcrypto-compat-0.9.7 zlib"

PACKAGES = "enigma2-plugin-softcams-evocamd"

PROVIDES += "openvix-softcams-evocamd"
RPROVIDES:enigma2-plugin-softcams-evocamd += "openvix-softcams-evocamd"
...
FILES:enigma2-plugin-softcams-evocamd = "/usr"
