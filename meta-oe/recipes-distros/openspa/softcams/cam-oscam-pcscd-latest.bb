SUMMARY:${PN} = "OSCam-pscd-latest ${PKGV}"
...
DEPENDS += "libusb openssl libdvbcsa pcsc-lite"
RDEPENDS:${PN} += "libdvbcsa libusb1 pcsc-lite"
...
do_install() {
    ...
    install -m 0755 ${UNPACKDIR}/init2 ${D}/usr/script/Oscam-pcscd-latest_cam.sh
    install -d ${D}/usr/bin
    install -m 0755 ${B}/oscam ${D}/usr/bin/${CAMNAME}
    install -m 0755 ${B}/utils/list_smargo ${D}/usr/bin/list_smargo
