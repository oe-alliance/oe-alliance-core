...
FILES_enigma2-plugin-skins-metrix-spa-fhd-icons = "${datadir}/enigma2/MetrixHD/FHD"
FILES_enigma2-plugin-skins-metrix-spa-uhd-icons = "${datadir}/enigma2/MetrixHD/UHD"
FILES_${PN}-src = "\
...
FILES_${PN} = "${libdir} ${datadir} ${sysconfdir}"
...
do_install() {
    ...
    cp -r --preserve=mode,links ${S}${sysconfdir}/enigma2/* ${D}${sysconfdir}/enigma2/
}
