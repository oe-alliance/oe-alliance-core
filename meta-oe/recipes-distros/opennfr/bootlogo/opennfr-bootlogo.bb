...
INITSCRIPT_PARAMS:vuduo2 = "start 70 S . stop 89 0 ."
INITSCRIPT_PARAMS:vusolo2 = "start 70 S . stop 89 0 ."
INITSCRIPT_PARAMS:vusolose = "start 70 S . stop 89 0 ."
INITSCRIPT_PARAMS:vusolo4k = "start 70 S . stop 89 0 ."
...
SRC_URI += "${@bb.utils.contains("MACHINE_FEATURES", "dreambox", "https://source.mynonpublic.com/dreambox/dreambox-bootlogo_${BINARY_VERSION}_${MACHINE_ARCH}.tar.bz2;name=${MACHINE_ARCH}" , "", d)}"
