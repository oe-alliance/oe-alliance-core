...
SRC_URI = "file://bootlogo.mvi file://bootlogo.sh \
    ...
    ${@bb.utils.contains("MACHINE_FEATURES", "gigabluebootvideo", "file://bootvideo.mp4 file://bootvideo" , "", d)} \
"
...
do_install() {
    ...
    ${@bb.utils.contains("MACHINE_FEATURES", "gigabluebootvideo", "install -m 0644 bootvideo.mp4 ${D}/usr/share/bootvideo.mp4" , "", d)}
    ${@bb.utils.contains("MACHINE_FEATURES", "gigabluebootvideo", "install -d ${D}/usr/bin" , "", d)}
    ${@bb.utils.contains("MACHINE_FEATURES", "gigabluebootvideo", "install -m 0755 ${S}/bootvideo ${D}/usr/bin/bootvideo" , "", d)}
