...
SRC_URI="${@bb.utils.contains("DISTRO_TYPE", "release", "git://github.com/openatv/MetrixHD.git;protocol=git" , "git://github.com/openatv/MetrixHD.git;protocol=git;branch=dev", d)}"
