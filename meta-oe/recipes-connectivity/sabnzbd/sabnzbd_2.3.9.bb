...
RDEPENDS_${PN} = "\
    ...
    ${PYTHON_PN}-misc ${PYTHON_PN}-multiprocessing ${PYTHON_PN}-sabyenc ${PYTHON_PN}-sqlite3 ${PYTHON_PN}-shell ${@bb.utils.contains("PYTHON_PN", "python", "${PYTHON_PN}-subprocess", "", d)} ${PYTHON_PN}-yenc \
    "
