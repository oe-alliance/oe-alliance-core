DESCRIPTION = "Twisted is an event-driven networking framework written in Python and licensed under the MIT license. \
...
RDEPENDS_${PN}-protocols-haproxy = "${PN}-core ${PN}-protocols"
RDEPENDS_${PN}-protocols-test = "${PN}-core ${PN}-protocols"
RDEPENDS_${PN}-positioning = "${PN}-core ${PN}-protocols"
RDEPENDS_${PN}-runner = "${PN}-core ${PN}-protocols"
RDEPENDS_${PN}-trial = "${PN}-core"
...
FILES_${PN}-protocols-haproxy = " \
    ${libdir}/${PYTHON_DIR}/site-packages/twisted/protocols/haproxy/*.py* \
    ${libdir}/${PYTHON_DIR}/site-packages/twisted/protocols/haproxy/test/*.py* \
"

FILES_${PN}-protocols-test = " \
    ${libdir}/${PYTHON_DIR}/site-packages/twisted/protocols/test/*.py* \
"
