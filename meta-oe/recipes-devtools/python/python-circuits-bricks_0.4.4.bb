...
RDEPENDS_${PN} = "python-circuits"

SRC_URI = "https://files.pythonhosted.org/packages/93/bd/a5400ce8f393b921bd471e6816fdea1abb5be3b50adc07dd8fe1810743fe/circuits-bricks-0.4.4.tar.gz"
...
S = "${WORKDIR}/circuits-bricks-0.4.4"
