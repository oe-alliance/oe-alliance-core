...
FILES_${PN}-dev_append_ebox5000 = " ${includedir}/linux/tc_ematch/*.h ${includedir}/linux/nl80211.h"
...
FILES_${PN}-dev_append_ebox5100 = " ${includedir}/linux/tc_ematch/*.h ${includedir}/linux/nl80211.h"
