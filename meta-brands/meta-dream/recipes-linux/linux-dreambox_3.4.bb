...
PATCHREV = "${@bb.utils.contains('MACHINE', 'dm520', \
    '12f469d9f8fedb33ccc4fd22a7451a800821f496', 'a904cb737a1d95034adc4717200cdf1e52ec8549', d)}"
PATCHLEVEL = "${@bb.utils.contains('MACHINE', 'dm520', '111', '110', d)}"

EXT = "${@bb.utils.contains('MACHINE', 'dm520', '-dm520', '', d)}"
...
BRCM_PATCHLEVEL = "${@bb.utils.contains('MACHINE', 'dm520', '3.9', '3.5', d)}"
