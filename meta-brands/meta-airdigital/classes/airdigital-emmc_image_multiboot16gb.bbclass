...
IMAGE_CMD:airdigitalemmc () {
    ...
    echo "boot emmcflash0.linuxkernel1 'root=/dev/mmcblk0p12 rootsubdir=linuxrootfs1 kernel=/dev/mmcblk0p3 rw rootwait coherent_pool=2M ${MACHINE}_4.boxmode=1'" > ${WORKDIR}/STARTUP
    echo "boot emmcflash0.linuxkernel1 'root=/dev/mmcblk0p12 rootsubdir=linuxrootfs1 kernel=/dev/mmcblk0p3 rw rootwait coherent_pool=2M ${MACHINE}_4.boxmode=1'" > ${WORKDIR}/STARTUP_LINUX_1_BOXMODE_1
    echo "boot emmcflash0.linuxkernel2 'root=/dev/mmcblk0p12 rootsubdir=linuxrootfs2 kernel=/dev/mmcblk0p4 rw rootwait coherent_pool=2M ${MACHINE}_4.boxmode=1'" > ${WORKDIR}/STARTUP_LINUX_2_BOXMODE_1
    echo "boot emmcflash0.linuxkernel3 'root=/dev/mmcblk0p12 rootsubdir=linuxrootfs3 kernel=/dev/mmcblk0p5 rw rootwait coherent_pool=2M ${MACHINE}_4.boxmode=1'" > ${WORKDIR}/STARTUP_LINUX_3_BOXMODE_1
    echo "boot emmcflash0.linuxkernel4 'root=/dev/mmcblk0p12 rootsubdir=linuxrootfs4 kernel=/dev/mmcblk0p6 rw rootwait coherent_pool=2M ${MACHINE}_4.boxmode=1'" > ${WORKDIR}/STARTUP_LINUX_4_BOXMODE_1
    echo "boot emmcflash0.linuxkernel5 'root=/dev/mmcblk0p12 rootsubdir=linuxrootfs5 kernel=/dev/mmcblk0p7 rw rootwait coherent_pool=2M ${MACHINE}_4.boxmode=1'" > ${WORKDIR}/STARTUP_LINUX_5_BOXMODE_1
    echo "boot emmcflash0.linuxkernel6 'root=/dev/mmcblk0p12 rootsubdir=linuxrootfs6 kernel=/dev/mmcblk0p8 rw rootwait coherent_pool=2M ${MACHINE}_4.boxmode=1'" > ${WORKDIR}/STARTUP_LINUX_6_BOXMODE_1
    echo "boot emmcflash0.linuxkernel7 'root=/dev/mmcblk0p12 rootsubdir=linuxrootfs7 kernel=/dev/mmcblk0p9 rw rootwait coherent_pool=2M ${MACHINE}_4.boxmode=1'" > ${WORKDIR}/STARTUP_LINUX_7_BOXMODE_1
    echo "boot emmcflash0.linuxkernel8 'root=/dev/mmcblk0p12 rootsubdir=linuxrootfs8 kernel=/dev/mmcblk0p10 rw rootwait coherent_pool=2M ${MACHINE}_4.boxmode=1'" > ${WORKDIR}/STARTUP_LINUX_8_BOXMODE_1
