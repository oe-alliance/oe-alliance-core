...
IMAGE_CMD:airdigitalemmc () {
    ...
    mkdir -p ${IMGDEPLOYDIR}/userdata/linuxrootfs9
    mkdir -p ${IMGDEPLOYDIR}/userdata/linuxrootfs10
    mkdir -p ${IMGDEPLOYDIR}/userdata/linuxrootfs11
    mkdir -p ${IMGDEPLOYDIR}/userdata/linuxrootfs12
    ...
    mcopy -i ${WORKDIR}/boot.img -v ${WORKDIR}/STARTUP_LINUX_9_BOXMODE_1 ::
    mcopy -i ${WORKDIR}/boot.img -v ${WORKDIR}/STARTUP_LINUX_10_BOXMODE_1 ::
    mcopy -i ${WORKDIR}/boot.img -v ${WORKDIR}/STARTUP_LINUX_11_BOXMODE_1 ::
    mcopy -i ${WORKDIR}/boot.img -v ${WORKDIR}/STARTUP_LINUX_12_BOXMODE_1 ::
    ...
    mcopy -i ${WORKDIR}/boot.img -v ${WORKDIR}/STARTUP_LINUX_9_BOXMODE_12 ::
    mcopy -i ${WORKDIR}/boot.img -v ${WORKDIR}/STARTUP_LINUX_10_BOXMODE_12 ::
    mcopy -i ${WORKDIR}/boot.img -v ${WORKDIR}/STARTUP_LINUX_11_BOXMODE_12 ::
    mcopy -i ${WORKDIR}/boot.img -v ${WORKDIR}/STARTUP_LINUX_12_BOXMODE_12 ::
