...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/aic_load_fw.ko ${D}/lib/modules/${KV}/kernel/drivers/net/wireless/aic8800/aic_load_fw/aic_load_fw.ko
    install -d ${D}/lib/modules/${KV}/kernel/drivers/net/wireless/aic8800/aic8800_fdrv
    install -m 0644 ${WORKDIR}/aic8800_fdrv.ko ${D}/lib/modules/${KV}/kernel/drivers/net/wireless/aic8800/aic8800_fdrv/aic8800_fdrv.ko
    install -d ${D}/lib/modules/${KV}/kernel/drivers/bluetooth
    install -m 0644 ${WORKDIR}/aic_btusb.ko ${D}/lib/modules/${KV}/kernel/drivers/bluetooth/aic_btusb.ko
