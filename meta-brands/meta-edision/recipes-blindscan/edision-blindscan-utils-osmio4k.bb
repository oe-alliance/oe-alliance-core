...
FILES:edision-blindscan-dvbs-utils-osmio4k = "${bindir}/blindscan"
FILES:edision-blindscan-dvbc-utils-osmio4k = "${bindir}/tda1002x"
...
INSANE_SKIP:edision-blindscan-dvbs-utils-osmio4k = "file-rdeps already-stripped 32bit-time"
INSANE_SKIP:edision-blindscan-dvbc-utils-osmio4k = "file-rdeps already-stripped 32bit-time"
