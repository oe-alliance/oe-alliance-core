...
do_install() {
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-cubic_streamer_0.6.1_mips32el.ipk ${DEPLOY_DIR_IPK}/3rdparty
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-hetweer_1.2_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
	install -m 0644 ${S}/enigma2-plugin-extensions-hdmitest_0.4_mipsel.ipk ${DEPLOY_DIR_IPK}/3rdparty
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-tspanel_6.7_mips32el.ipk ${DEPLOY_DIR_IPK}/3rdparty
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-webmedia_9.2_r0_oe2.0_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
...
# 	Install any packages that are only For this machines feed here,
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-et-webbrowser_1.6.1-r0_et4x00.ipk ${DEPLOY_DIR_IPK}/3rdparty
...
# 	Install any packages that are only For this machines feed here,
	install -m 0644 ${S}/enigma2-plugin-extensions-et-portal_2.0_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
	install -m 0644 ${S}/enigma2-plugin-extensions-et-webbrowser_1.6.1-r0_et6x00.ipk ${DEPLOY_DIR_IPK}/3rdparty
...
# 	Install any packages that are only For this machines feed here,
	install -m 0644 ${S}/enigma2-plugin-extensions-et-portal_2.0_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
	install -m 0644 ${S}/enigma2-plugin-extensions-et-webbrowser_1.6.1-r0_et9x00.ipk ${DEPLOY_DIR_IPK}/3rdparty
