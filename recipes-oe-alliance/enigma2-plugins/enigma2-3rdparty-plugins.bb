...
do_install_vuuno() {
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-livefootball-oe2.0_4.2_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-webradiofs_8.28_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
