...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-camofs_7.37_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-tsmedia-oe2.0_2.8_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
