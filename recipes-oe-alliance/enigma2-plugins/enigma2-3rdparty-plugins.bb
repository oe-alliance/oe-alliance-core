...
do_install_vuuno() {
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-picturecenterfs_3.44_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-webradiofs_8.25_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
	...
	install -m 0644 ${S}/enigma2-plugin-enigma2-plugin-extensions-rtlxl_0.5a_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
