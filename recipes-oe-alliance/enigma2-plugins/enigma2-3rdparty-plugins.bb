...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-autobouquets-e2_201303010205_mipsel.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-tsmedia-oe2.0_3.2_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
