...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-sportmax_1.1-r1_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-tsmedia-oe2.0_2.2_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-webradiofs_10.33_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
