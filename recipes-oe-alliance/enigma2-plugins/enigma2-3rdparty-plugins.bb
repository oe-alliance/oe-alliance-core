...
do_install_vuuno() {
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-autobouquets-e2_0.2_mips32el.ipk ${DEPLOY_DIR_IPK}/3rdparty
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-webradiofs_8.29_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
