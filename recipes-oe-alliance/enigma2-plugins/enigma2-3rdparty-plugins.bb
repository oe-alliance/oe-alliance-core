...
do_install_vuuno() {
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-buyukbangpanel_1.3.1_mipsel.ipk ${DEPLOY_DIR_IPK}/3rdparty
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-atmolightd_0.6-r0_mipsel.ipk ${DEPLOY_DIR_IPK}/3rdparty
	install -m 0644 ${S}/enigma2-plugin-extensions-autobouquets-e2-201208212300_all.ipk ${DEPLOY_DIR_IPK}/3rdparty
