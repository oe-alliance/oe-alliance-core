...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-enhancedmoviecenter_3.6.7beta20130104_all ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-mediaportal_1.8_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	install -m 0644 enigma2-plugin-extensions-mtv_0.1_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	install -m 0644 enigma2-plugin-extensions-et-multiquickbutton_r2.8.4_mipsel ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-seriesplugin_0.8.2.1_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-webradiofs_10.02_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
...
# 	Install any packages that are only For this machines feed here,
	install -m 0644 enigma2-plugin-extensions-et-portal_2.5_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
