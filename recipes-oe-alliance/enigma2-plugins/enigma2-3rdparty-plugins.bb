...
do_install_vuuno() {
	...
	install -m 0644 ${S}/enigma2-plugin-extensions-dreamexplorer_7.3_mipsel.1.ipk ${DEPLOY_DIR_IPK}/3rdparty
	install -m 0644 ${S}/enigma2-plugin-extensions-et-livestream_1.0-r0_mipsel.ipk ${DEPLOY_DIR_IPK}/3rdparty
	install -m 0644 ${S}/enigma2-plugin-extensions-et-openug_1.1-r0_mipsel.1.ipk ${DEPLOY_DIR_IPK}/3rdparty
