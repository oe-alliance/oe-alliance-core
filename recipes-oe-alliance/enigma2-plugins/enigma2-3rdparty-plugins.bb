...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-camofs_7.04_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-iptv-list-updater_0.80-r1_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-tsmedia-oe2.0_2.5_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
