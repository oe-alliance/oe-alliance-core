...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-1channel_1.3_mipsel.ipk ${WORKDIR}/deploy-ipks/3rdparty
	install -m 0644 enigma2-plugin-extensions-appletrailer_0.1_mipsel.ipk ${WORKDIR}/deploy-ipks/3rdparty
	install -m 0644 enigma2-plugin-extensions-atmolightd_0.6-r0_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
	install -m 0644 enigma2-plugin-extensions-boblight-enigma2_0.5r10_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-camofs_6.42_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
	install -m 0644 enigma2-plugin-extensions-cubic_streamer_0.6.1_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-transmission_2.61-r13447_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	install -m 0644 enigma2-plugin-extensions-tspanel_6.7_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
...
# 	Install any packages that are only For this machines feed here,
	install -m 0644 enigma2-plugin-extensions-et-portal_2.0_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
