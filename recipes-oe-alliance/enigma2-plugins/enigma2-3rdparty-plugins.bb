...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-aspectratioswitch_0.8_mips32el ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-mediainfo_0.2_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	install -m 0644 enigma2-plugin-extensions-mediaportal_2.9_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
...
# 	Install any packages that are only For this machines feed here,
	install -m 0644 enigma2-plugin-extensions-et-portal_2.6_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
