...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-mediaportal_0.1_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-extensions-rteplayer_0.1-beta_mips32el.ipk ${WORKDIR}/deploy-ipks/3rdparty
