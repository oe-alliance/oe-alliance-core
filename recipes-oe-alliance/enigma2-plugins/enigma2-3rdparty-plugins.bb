...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-picturecenterfs_3.60_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-webradiofs_10.25_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
