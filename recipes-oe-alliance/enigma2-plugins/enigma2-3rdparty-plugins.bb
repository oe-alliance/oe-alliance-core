...
do_deploy() {
	...
	install -m 0644 enigma2-plugin-extensions-camofs_6.63_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-mediainfo_0.6_r01_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
	install -m 0644 enigma2-plugin-extensions-mediaportal_4.3.0_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
	...
	install -m 0644 enigma2-plugin-extensions-tsmedia-oe2.0_2.3_all.ipk ${WORKDIR}/deploy-ipks/3rdparty
...
# 	Install any packages that are only For this machines feed here, uncomment the line below and change as required
	install -m 0644 enigma2-plugin-extensions-sdg-imagedownloader-oe-2.0-vu-all.ipk ${WORKDIR}/deploy-ipks/3rdparty
}
