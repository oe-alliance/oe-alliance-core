...
python do_package_prepend () {
    boxtypes = [
        ...
        ('sezamhde', 'sezam-1000.jpg', 'ini-1000.png'),
        ('sezamhdx', 'sezam-5000.jpg', 'ini-1000.png'),
        ('sezamhdp', 'sezam-9000.jpg', 'xpeedlx.png'),
        ('xpeedlx', 'xpeedlx.jpg', 'xpeedlx.png'),
        ('xpeedlx3', 'xpeedlx3.jpg', 'xpeedlx.png'),
        ('mbmini', 'ini-1000sv.jpg', 'miraclebox.png'),
        ('mbtwin', 'ini-5000sv.jpg', 'miraclebox.png'),
    ]
    import os
        ...
        for name in files:
            if target_box != name and name != 'unknown.jpg':
                if target_box == 'ini-3000.jpg':
                    if name not in ('ini-3000.jpg', 'ini-5000.jpg', 'ini-7000.jpg'):
        ...
        for name in files:
            if target_remote != name and name != 'ow_remote.png':
                if target_remote == 'ini-3000.png':
                    if name not in ('ini-1000.png', 'ini-3000.png', 'ini-5000.png', 'ini-7000.png'):
                        os.remove(os.path.join(root, name))
