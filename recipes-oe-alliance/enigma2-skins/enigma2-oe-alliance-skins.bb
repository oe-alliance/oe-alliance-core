...
RDEPENDS_${EPSM}-neonovum-hd-weather = "novum-hd-renderer novum-hd-common enigma2-plugin-extensions-weatherplugin enigma2-plugin-systemplugins-weathercomponent"
RDEPENDS_${EPSM}-mynovum-hd = "novum-hd-renderer novum-hd-common"
RDEPENDS_${EPSM}-mynovum-hd-weather = "novum-hd-renderer novum-hd-common enigma2-plugin-extensions-weatherplugin enigma2-plugin-systemplugins-weathercomponent"
