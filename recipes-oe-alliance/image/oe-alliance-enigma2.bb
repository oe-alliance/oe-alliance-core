...
RRECOMMENDS = "\
	...
	${@base_contains("MACHINE_FEATURES", "dvd", "cdfs cdtextinfo enigma2-plugin-extensions-cdinfo enigma2-plugin-extensions-dvdburn enigma2-plugin-extensions-dvdplayer", "", d)} \
