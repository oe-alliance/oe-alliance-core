...
RRECOMMENDS_append_vuuno = " vuplus-opera-browser-${MACHINE} vuplus-opera-browser-util"
RRECOMMENDS_append_vuultimo = " vuplus-opera-browser-${MACHINE} vuplus-opera-browser-util"
RRECOMMENDS_append_vusolo = " vuplus-opera-browser-${MACHINE} vuplus-opera-browser-util"
RRECOMMENDS_append_vuduo = " vuplus-opera-browser-${MACHINE} vuplus-opera-browser-util"
