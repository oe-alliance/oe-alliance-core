...
DEPENDS = "\
	...
	${@base_contains("MACHINE_BRAND", "Vu+", "enigma2-plugin-drivers-network-usb-rt5572" , "", d)} \
	${@base_contains("MACHINE", "gbquad", "enigma2-plugin-drivers-network-usb-rt3573 enigma2-plugin-drivers-network-usb-rt5572" , "", d)} \
